...
const AddRoom = () => {
    ...
    const onSubmitHandler = async (e)=>{
        ...
        try {
            ...
            //Converting Amenities to Array & keeping onli enabled amenities
                ...
                {Object.keys(inputs.amenities).map((amenity, index)=>(
                    <div key={index}>
                        <input 
                            ...
                            onChange={(e)=>setInputs({...inputs, amenities: {...inputs.amenities, [amenity]: e.target.checked}})}
                        />
