...
export const Hero = () => {
    ...
    const onSearch = async (e) => {
        ...
        //add destination to searched citties max 3 recnt searched cities
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Event Planner</p>
        <h1 className='font-playfair text-2x1 md:text-5x1 md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-x1 mt-4'>Discover The Perfect Way To Plan Your Event</h1>
        <p className='max-w-130 mt-2 text-sm md:text-base'>Plan unforgettable events with ease — book top venues, services, and experiences all in one place.</p>
